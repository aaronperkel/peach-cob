          ...
          <tbody>
            {billTypes.map((bt) => (
              <tr key={bt.id}>
                ...
                <td className="text-ink-muted">{bt.ownerName ?? "—"}</td>
          ...
          <div className="panel max-h-[85dvh] w-full max-w-md overflow-y-auto p-6 shadow-xl">
            ...
            <form action={saveBillType}>
              ...
              <div className="mt-4 grid gap-4 sm:grid-cols-2">
                <div>
                  <label className="field-label" htmlFor="billtype_owner">Whose account</label>
                  <select
                    className="field-input"
                    id="billtype_owner"
                    name="billtype_owner"
                  ...
                  <p className="mt-1 text-xs text-ink-muted">
                    She pays the provider; the others pay her back.
                  </p>
                </div>
                <div>
